namespace ConsoleApplication1
{
    ...
    using TinyIoCContainer = TinyIoC.TinyIoCContainer;
    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Running a http server on port 7070");
                Console.ReadKey();
            }
        }
    }
    ...
    public class MyBootstrapper : VQDefaultNancyBootstrapper
    {
        protected override void ConfigureRequestContainer(TinyIoCContainer container, NancyContext context)
        {
            base.ConfigureRequestContainer(container, context);

            container.Register<IBlah, Blah>();

            Func<IFoo> factory = () => new Foo(container.Resolve<IBlah>());
    ...
    public class Errorhandler : IStatusCodeHandler
    {
        ...
        public Errorhandler(Func<IFoo> fooFunc)
        {
    ...
    /// </summary>
    public class VQDefaultNancyBootstrapper : NancyBootstrapperWithRequestContainerBase<TinyIoCContainer>
    {
        /// <summary>
